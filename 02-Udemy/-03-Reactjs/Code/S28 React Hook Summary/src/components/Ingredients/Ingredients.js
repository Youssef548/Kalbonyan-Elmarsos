...
const Ingredients = () => {
  ...
  const removeIngredientHandler = useCallback(
    (ingredientId) => {
      sendRequest(
        `https://react-hooks-update-dd2d0-default-rtdb.firebaseio.com/ingredients/${ingredientId}.json`,
        'DELETE',
        null,
        ingredientId,
        'REMOVE_INGREDIENT'
  ...
  return (
    <div className='App'>
      ...
      <IngredientForm onIngredient={addIngredientHandler} loading={isLoading} />
